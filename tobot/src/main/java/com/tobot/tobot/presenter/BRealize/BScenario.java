...
import com.tobot.tobot.scene.MusicClassifyScenario;
import com.tobot.tobot.scene.SongScenario;
import com.tobot.tobot.scene.StoryScenario;
import com.tobot.tobot.scene.TaleClassifyScenario;
...
public class BScenario implements IScene {
    ...
    public BScenario(ICommonInterface mISceneV){
...
//        scenarioManager.addScenario(new VolumeScenario(mContent,mAudioManager));
        ...
        scenarioManager.addScenario(new MusicClassifyScenario(mContent,"原地动作"));
        scenarioManager.addScenario(new CustomActionScenario(mContent,"动作控制"));
        scenarioManager.addScenario(new TaleClassifyScenario(mContent,"走动作"));
    }
}
